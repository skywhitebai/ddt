...
<div>
    ...
    <a href="javascript:void(0)" onclick="exportSalesGroupFinancialStatement()" class="easyui-linkbutton">导出销售分组财务报表</a>
...
<script type="text/javascript">
    ...
    function exportSalesGroupFinancialStatement() {
        ...
        window.open('${pageContext.request.contextPath }/financialStatement/exportSalesGroupFinancialStatement?month=' + month);
    }
