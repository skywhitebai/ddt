...
<script type="text/javascript">
    ...
    function bindData() {
        ...
        $(dg).datagrid({   //定位到Table标签，Table标签的ID是grid
            ...
            columns: [[
                ...
                {
                    title: '状态', field: 'status', width: 180,
    ...
    function exportDeveloperFinancialStatement() {
        ...
        window.open('${pageContext.request.contextPath }/financialStatement/exportCurrentUserDeveloperFinancialStatement?month=' + month);
    }
