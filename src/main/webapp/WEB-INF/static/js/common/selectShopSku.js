    ...
    $(dg).datagrid({   //定位到Table标签，Table标签的ID是grid
            ...
            columns: [[
                ...
                {title: '产品名称', field: 'productName', width: 160},
                {
                    ...
                    var content = '<a href="javascript:void(0)" onclick="selectShopSku(\'' + row.shopSku + '\')" class="easyui-linkbutton" >选择</a>';
                    return content;
                }
                }
            ]],
...
function selectShopSku(shopSku) {
    $('#info_shopSkuId').val(shopSku);
